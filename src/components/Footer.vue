  ...
  <div>
    ...
    >
      <div class="flex justify-center md:order-2">
        <a
          href="https://www.instagram.com/deckneun"
        ...
        <a
          href="https://twitter.com/PhilReinking"
          class="ml-6 text-gray-600 hover:text-gray-800"
        >
        ...
        <a
          href="https://github.com/Deck9/consent-generator"
